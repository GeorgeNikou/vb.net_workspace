...
Public Class vSearch
    ...
    Private Sub vSearch_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub btn_search_videolist_Click(sender As Object, e As EventArgs) Handles btn_search_videolist.Click
        Try
            ...
            Dim name = txt_search_videolist.Text

            Dim query As String = "SELECT video_id, title, year, country, language, length, resume, genre, actors, director, status FROM vb_videos WHERE title like '%" & name & "%' OR video_id like '%" & name & "%'"
            Dim datatable As New DataTable()
