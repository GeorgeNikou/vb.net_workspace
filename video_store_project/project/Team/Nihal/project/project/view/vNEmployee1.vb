Public Class vNEmployee1
    ...
    Private Sub mtx_number_NEmployee1_MaskInputRejected(sender As Object, e As MaskInputRejectedEventArgs) Handles mtx_number_NEmployee1.MaskInputRejected
    ...
    Private Sub mtx_cellno_NEmployee1_MaskInputRejected(sender As Object, e As MaskInputRejectedEventArgs) Handles mtx_cellno_NEmployee1.MaskInputRejected
        If mtx_cellno_NEmployee1.Text <> "" Then
            mtx_cellno_NEmployee1.BackColor = Color.Empty
        End If
    End Sub
