Public Class clientBean
    ...
    'constructor
    Public Sub New(fname As String, lname As String, email As String, phone As Integer, dob As Date, age As Integer, address As String, city As String, province As String, postal As String, status As Boolean, level As Integer)
        _fname = fname
        _lname = lname
        _email = email
        _phone = phone
