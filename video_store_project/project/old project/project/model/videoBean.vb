Public Class videoBean
    ...
    'constructor
    Public Sub New(photo As Image, title As String, year As String, country As String, language As String, length As Integer, [resume] As String, genre As String, actor As String, director As String, status As Integer)
        _photo = photo
        _title = title
        _year = year
        _country = country
